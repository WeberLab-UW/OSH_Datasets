...
# %%
# File containing my github tokens to be cycled through
gh_tokens_cycler = GitHubTokensCycler("./tokens.yaml")

# %%
# STATUS: This script attempts to cycle though a list of git personal access tokens. This script does not currently work. 
...
class GitHubAPIClient:
    ...
    # Attempts to cycle through the tokens
    def fetch_all_data(self, owners: List[str], repos: List[str]) -> Dict[str, Any]:   
...
def main():
    ...
    client = GitHubAPIClient(token = gh_tokens_cycler )
